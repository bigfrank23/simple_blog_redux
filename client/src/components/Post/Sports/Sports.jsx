...
import { getPosts } from '../../../redux/actions/sportsPosts'
import { deletePost } from '../../../redux/actions/sportsPosts'
      ...
      <div id="container">
        ...
        <div className="container">
            <div className="col-2 text-center" id='search_box'>
                <h4 style={{textShadow: "2px 2px", position: "relative"}}>SPORTS</h4>
            </div>
                            ...
                            <div className="card_center d-flex">
                                <div className="col-4 d-flex flex-column">
                                    ...
                                    <div className="btn mx-1">
                                        <Link to={`/full_detail_sports/${val._id}`}>
